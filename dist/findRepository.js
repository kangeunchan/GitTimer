...
exports.listRepositories = exports.getRepository = void 0;
// repository.ts
...
function getRepository(owner, repo) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, octokit_1.octokit.request("GET /repos/{owner}/{repo}", {
                        owner: owner,
                        repo: repo,
                    })];
                case 1:
...
function listRepositories() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, octokit_1.octokit.request("GET /user/repos")];
                case 1:
                    data = (_a.sent()).data;
                    repositories = data.map(function (repo) {
                        ...
                        return ({
                            ...
                            language: (_b = repo.language) !== null && _b !== void 0 ? _b : "",
